                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        <XAxis
                            type="number"
                            dataKey="n"
                            name="N (Rentability Change)"
                            stroke="#9ca3af"
                            label={{ value: "N (Profitability Δ)", position: "insideBottom", offset: -10, fill: "#9ca3af" }}
                            height={30}
                        />
                        <YAxis
                            type="number"
                            dataKey="m"
                            name="M (Market Elasticity)"
                            stroke="#9ca3af"
                            label={{ value: "M (Elasticity)", angle: -90, position: "insideLeft", fill: "#9ca3af", offset: 10 }}
                        />
                        <Tooltip
                            contentStyle={{
